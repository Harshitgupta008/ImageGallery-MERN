...
import { RegisterUser, LoginUser, UserAuthentication,UpdateUser, UserMessageSend, GetAllmessage, ImageUpload, Getimages, DeleteMessage, DeleteImages } from "../Controller/account.controller.js"
...
router.route("/api/updateuser").patch(UpdateUser);
